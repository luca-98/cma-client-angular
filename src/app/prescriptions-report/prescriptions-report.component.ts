...
@Component({
  selector: 'app-prescriptions-report',
  templateUrl: './prescriptions-report.component.html',
  styleUrls: ['./prescriptions-report.component.scss']
})
export class PrescriptionsReportComponent implements OnInit {
  id: string;
  ...
  loadContent() {
    this.commonService.getPrescriptionsyId(this.id)
      .subscribe(
        (res: any) => {
