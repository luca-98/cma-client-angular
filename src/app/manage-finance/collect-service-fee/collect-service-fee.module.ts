...
import { CollectServiceFeeRoutingModule } from './collect-service-fee-routing.module';
...
@NgModule({
  declarations: [CollectServiceFeeComponent],
  imports: [
    CommonModule,
    CollectServiceFeeRoutingModule,
    MatCardModule,
    MatButtonModule,
    MatFormFieldModule,
    MatInputModule,
...
export class CollectServiceFeeModule { }
