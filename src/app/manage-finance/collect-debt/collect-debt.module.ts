...
import { CollectDebtRoutingModule } from './collect-debt-routing.module';
...
@NgModule({
  declarations: [CollectDebtComponent],
  imports: [
    CommonModule,
    CollectDebtRoutingModule,
    MatCardModule,
    MatButtonModule,
    MatFormFieldModule,
    MatInputModule,
...
export class CollectDebtModule { }
